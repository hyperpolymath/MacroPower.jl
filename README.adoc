...
link:TOPOLOGY.md[image:https://img.shields.io/badge/Completion-20%25-red[20]]
https://www.bestpractices.dev/en/projects/new?repo_url=https://github.com/hyperpolymath/MacroPower.jl[image:https://img.shields.io/badge/OpenSSF-Best_Practices-green?logo=opensourcesecurity[OpenSSF
Best Practices]]
