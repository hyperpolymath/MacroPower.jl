...
doctor:
    @echo "Running diagnostics for MacroPower.jl..."
...
help-me:
    @echo "=== MacroPower.jl Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/MacroPower.jl/issues/new"
    @echo ""
